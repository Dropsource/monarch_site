...
<img className="docs-screenshot macos" alt="Debug Controls" src={useBaseUrl('/docs/assets/debug-controls.png')} />
...
<img className="docs-screenshot macos" alt="DevTools breakpoint hit" src={useBaseUrl('/docs/assets/devtools-breakpoint-hit.png')} />
...
<img className="docs-screenshot macos" alt="Exception caught by Monarch" src={useBaseUrl('/docs/assets/exception-caught-by-monarch.png')} />
...
<img alt="Funny Meme" src={useBaseUrl('/blog/assets/meme-01.png')} />
