...
import meme from '/blog/assets/meme-private-repo.png';
...
We updated and augmented the 
[Monarch Samples](https://github.com/Dropsource/monarch_samples) repo. 
The samples repo now includes several projects which showcase Monarch working with
various packages, patterns and tools, such as:
...
<div className="text--center blog-video">
