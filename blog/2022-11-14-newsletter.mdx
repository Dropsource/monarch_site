...
We are super excited about this announcement. It has been a lot of work. It 
took us longer than we thought because we run into unexpected issues. However, 
...
Flutter and Dart code across all platforms. It also makes contributions from the community easier. And it sets Monarch up for future features like add-ons and CI integrations.

The Monarch source code is in our main [GitHub repo](https://github.com/Dropsource/monarch). 
...
[install it](https://monarchapp.io/docs/install). Or, if you already have Monarch installed, just run `monarch upgrade`.
