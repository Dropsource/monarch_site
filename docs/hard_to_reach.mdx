...
A use case in an app is hard to reach when you have to take multiple steps to get to it, 
or when you have to spend energy setting things up so you can reach it. 
An example of a hard to reach use cases is the last step of an onboarding screen or an 
onboarding workflow.
