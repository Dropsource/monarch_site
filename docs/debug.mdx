...
<img className="docs-screenshot macos" alt="Select Widget Mode" src={useBaseUrl('/docs/assets/select-widget-mode.png')} />
<br/>
<img className="docs-screenshot macos" alt="Details Tree" src={useBaseUrl('/docs/assets/details-tree.png')} />
