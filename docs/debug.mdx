...
_DevTools will not show your widgets under its Widget tree on the left side or under 
the Layout Explorer tab. Monarch renders 
your stories and widgets dynamically so DevTools doesn't have enough diagnostics 
information to generate the widget tree. To see your widgets in DevTools use 
"Select Widget Mode" as described below._
